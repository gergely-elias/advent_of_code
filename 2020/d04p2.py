...
for passport in passports:
  ...
  if len(passport_fields) == 8 or (len(passport_fields) == 7 and 'cid' not in passport_fields):
    if (int(passport_fields['byr']) in range(1920, 2003)) \
      and (int(passport_fields['iyr']) in range(2010, 2021)) \
      and (int(passport_fields['eyr']) in range(2020, 2031)) \
      and ((passport_fields['hgt'][-2:] == 'cm' and int(passport_fields['hgt'][:-2]) in range(150, 194)) or (passport_fields['hgt'][-2:] == 'in' and int(passport_fields['hgt'][:-2]) in range(59, 77))) \
