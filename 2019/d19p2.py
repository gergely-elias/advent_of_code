    ...
    if operation == 1:
      ...
      if looking_for_top_left_corner:
        ...
        if square_bottom_left_y >= size + top_left_y - 1:
          if right_edge_x[square_bottom_left_y - size + 1] - left_edge_x[square_bottom_left_y] + 1 >= size:
            print((square_bottom_left_y - size + 1) * 10000 + left_edge_x[square_bottom_left_y])
            exit()
    elif operation == 5:
      if address[0] != 0:
        position = address[1]
